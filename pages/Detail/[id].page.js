...
//added
import Product7 from "../Component/Product9";
import Product8 from "../Component/Product10";
    ...
    if (router.isReady) {
      ...
      const fetchData = async () => {
        try {
          ...
          setuserid(data[0].user.userId);
          setphonenumber(data[0].user.profile.phonenumber);
